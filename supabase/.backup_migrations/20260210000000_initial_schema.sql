-- =============================================================================
-- Migration inicial: Schema base do Sinesys 2.0
-- Gerada automaticamente a partir dos arquivos em supabase/schemas/
-- Fase 1: Cria tabelas sem FK constraints (resolve dependencias circulares)
-- Fase 2: Adiciona FK constraints no final
-- =============================================================================

-- ---------------------------------------------------------------------------
-- Arquivo: 00_permissions.sql
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Arquivo: 04_acervo_functions.sql
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Arquivo: 05_acervo_unificado_view.sql
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Arquivo: 05_remove_timeline_mongodb_id_from_acervo.sql
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Arquivo: 07_tipos_expedientes.sql
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Arquivo: 10_partes_contrarias.sql
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Arquivo: 12_contrato_processos.sql
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Arquivo: 17_processo_partes.sql
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Arquivo: 19_audiencias_auxiliares.sql
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Arquivo: 20_acordos_condenacoes.sql
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Arquivo: 21_captura_logs_brutos.sql
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Arquivo: 22_cargos_permissoes.sql
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Arquivo: 24_processos_cliente_por_cpf_view.sql
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Arquivo: 25_assinatura_digital.sql
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Arquivo: 25_credenciais_add_usuario.sql
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Arquivo: 28_contas_bancarias.sql
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Arquivo: 29_lancamentos_financeiros.sql
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Arquivo: 31_conciliacao_bancaria.sql
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Arquivo: 33_financeiro_functions.sql
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Arquivo: 34_financeiro_views.sql
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Arquivo: 35_financeiro_integracao.sql
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Arquivo: 36_financeiro_seed.sql
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Arquivo: 37_documentos_chat.sql
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Arquivo: 42_contrato_partes.sql
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Arquivo: 43_contrato_status_historico.sql
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Arquivo: 46_contrato_tags_propagacao.sql
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Arquivo: 50_notificacoes_functions.sql
-- ---------------------------------------------------------------------------
...
-- =============================================================================
-- FASE 2: Foreign Key Constraints
-- =============================================================================

alter table public.credenciais add foreign key (advogado_id) references public.advogados(id);
alter table public.acervo add foreign key (advogado_id) references public.advogados(id) on delete cascade;
alter table public.expedientes add foreign key (advogado_id) references public.advogados(id) on delete cascade;
alter table public.expedientes add foreign key (processo_id) references public.acervo(id) on delete set null;
alter table public.expedientes add foreign key (responsavel_id) references public.usuarios(id) on delete set null;
alter table public.expedientes add foreign key (tipo_expediente_id) references public.tipos_expedientes(id) on delete set null;
alter table public.audiencias add foreign key (advogado_id) references public.advogados(id) on delete cascade;
alter table public.audiencias add foreign key (processo_id) references public.acervo(id) on delete cascade;
alter table public.audiencias add foreign key (orgao_julgador_id) references public.orgao_julgador(id) on delete set null;
alter table public.audiencias add foreign key (tipo_audiencia_id) references public.tipo_audiencia(id) on delete set null;
alter table public.audiencias add foreign key (classe_judicial_id) references public.classe_judicial(id) on delete set null;
alter table public.audiencias add foreign key (responsavel_id) references public.usuarios(id) on delete set null;
alter table public.tipos_expedientes add foreign key (created_by) references public.usuarios(id) on delete cascade;
alter table public.usuarios add foreign key (auth_user_id) references auth.users(id);
alter table public.usuarios add foreign key (cargo_id) references public.cargos(id);
alter table public.clientes add foreign key (endereco_id) references public.enderecos(id);
alter table public.clientes add foreign key (created_by) references public.usuarios(id) on delete set null;
alter table public.partes_contrarias add foreign key (endereco_id) references public.enderecos(id);
alter table public.partes_contrarias add foreign key (created_by) references public.usuarios(id) on delete set null;
alter table public.contratos add foreign key (segmento_id) references public.segmentos(id);
alter table public.contratos add foreign key (cliente_id) references public.clientes(id) on delete restrict;
alter table public.contratos add foreign key (responsavel_id) references public.usuarios(id) on delete set null;
alter table public.contratos add foreign key (created_by) references public.usuarios(id) on delete set null;
alter table public.contrato_processos add foreign key (contrato_id) references public.contratos(id) on delete cascade;
alter table public.contrato_processos add foreign key (processo_id) references public.acervo(id) on delete cascade;
alter table public.tribunais_config add foreign key (tribunal_id) references public.tribunais(id);
alter table public.orgaos_tribunais add foreign key ("tribunalId") references public.tribunais(id);
alter table public.logs_alteracao add foreign key (usuario_que_executou_id) references public.usuarios(id);
alter table public.logs_alteracao add foreign key (responsavel_anterior_id) references public.usuarios(id);
alter table public.logs_alteracao add foreign key (responsavel_novo_id) references public.usuarios(id);
alter table public.terceiros add foreign key (endereco_id) references public.enderecos(id);
alter table public.processo_partes add foreign key (processo_id) references public.acervo(id) on delete cascade;
alter table public.representantes add foreign key (endereco_id) references public.enderecos(id);
alter table public.sala_audiencia add foreign key (orgao_julgador_id) references public.orgao_julgador(id);
alter table public.acordos_condenacoes add foreign key (processo_id) references public.acervo(id);
alter table public.acordos_condenacoes add foreign key (created_by) references auth.users(id);
alter table public.parcelas add foreign key (acordo_condenacao_id) references public.acordos_condenacoes(id) on delete cascade;
alter table public.parcelas add foreign key (usuario_repasse_id) references public.usuarios(id);
alter table public.captura_logs_brutos add foreign key (advogado_id) references public.advogados(id);
alter table public.captura_logs_brutos add foreign key (credencial_id) references public.credenciais(id);
alter table public.capturas_log add foreign key (advogado_id) references public.advogados(id);
alter table public.agendamentos add foreign key (advogado_id) references public.advogados(id);
alter table public.cargos add foreign key (created_by) references public.usuarios(id);
alter table public.permissoes add foreign key (usuario_id) references public.usuarios(id) on delete cascade;
alter table public.cargo_permissoes add foreign key (cargo_id) references public.cargos(id) on delete cascade;
alter table public.layouts_painel add foreign key (usuario_id) references public.usuarios(id) on delete cascade;
alter table public.links_personalizados add foreign key (usuario_id) references public.usuarios(id) on delete cascade;
alter table public.tarefas add foreign key (usuario_id) references public.usuarios(id) on delete cascade;
alter table public.notas add foreign key (usuario_id) references public.usuarios(id) on delete cascade;
alter table public.nota_etiquetas add foreign key (usuario_id) references public.usuarios(id) on delete cascade;
alter table public.nota_etiqueta_vinculos add foreign key (nota_id) references public.notas(id) on delete cascade;
alter table public.nota_etiqueta_vinculos add foreign key (etiqueta_id) references public.nota_etiquetas(id) on delete cascade;
alter table public.kanban_columns add foreign key (usuario_id) references public.usuarios(id) on delete cascade;
alter table public.kanban_tasks add foreign key (usuario_id) references public.usuarios(id) on delete cascade;
alter table public.kanban_tasks add foreign key (column_id) references public.kanban_columns(id) on delete cascade;
alter table public.assinatura_digital_templates add foreign key (segmento_id) references public.segmentos(id);
alter table public.assinatura_digital_formularios add foreign key (segmento_id) references public.segmentos(id) on delete restrict;
alter table public.assinatura_digital_assinaturas add foreign key (segmento_id) references public.segmentos(id) on delete restrict;
alter table public.assinatura_digital_assinaturas add foreign key (formulario_id) references public.assinatura_digital_formularios(id) on delete restrict;
alter table public.assinatura_digital_documentos add foreign key (created_by) references public.usuarios(id);
alter table public.assinatura_digital_documento_assinantes add foreign key (documento_id) references public.assinatura_digital_documentos(id) on delete cascade;
alter table public.assinatura_digital_documento_ancoras add foreign key (documento_id) references public.assinatura_digital_documentos(id) on delete cascade;
alter table public.assinatura_digital_documento_ancoras add foreign key (documento_assinante_id) references public.assinatura_digital_documento_assinantes(id) on delete cascade;
alter table public.plano_contas add foreign key (conta_pai_id) references public.plano_contas(id) on delete restrict;
alter table public.plano_contas add foreign key (created_by) references public.usuarios(id);
alter table public.centros_custo add foreign key (centro_pai_id) references public.centros_custo(id) on delete restrict;
alter table public.centros_custo add foreign key (responsavel_id) references public.usuarios(id);
alter table public.centros_custo add foreign key (created_by) references public.usuarios(id);
alter table public.contas_bancarias add foreign key (conta_contabil_id) references public.plano_contas(id);
alter table public.contas_bancarias add foreign key (created_by) references public.usuarios(id);
alter table public.lancamentos_financeiros add foreign key (conta_bancaria_id) references public.contas_bancarias(id);
alter table public.lancamentos_financeiros add foreign key (conta_contabil_id) references public.plano_contas(id);
alter table public.lancamentos_financeiros add foreign key (centro_custo_id) references public.centros_custo(id);
alter table public.lancamentos_financeiros add foreign key (cliente_id) references public.clientes(id);
alter table public.lancamentos_financeiros add foreign key (contrato_id) references public.contratos(id);
alter table public.lancamentos_financeiros add foreign key (acordo_condenacao_id) references public.acordos_condenacoes(id);
alter table public.lancamentos_financeiros add foreign key (parcela_id) references public.parcelas(id);
alter table public.lancamentos_financeiros add foreign key (usuario_id) references public.usuarios(id);
alter table public.lancamentos_financeiros add foreign key (conta_destino_id) references public.contas_bancarias(id);
alter table public.lancamentos_financeiros add foreign key (lancamento_contrapartida_id) references public.lancamentos_financeiros(id);
alter table public.lancamentos_financeiros add foreign key (lancamento_origem_id) references public.lancamentos_financeiros(id);
alter table public.lancamentos_financeiros add foreign key (created_by) references public.usuarios(id);
alter table public.salarios add foreign key (usuario_id) references public.usuarios(id) on delete cascade;
alter table public.salarios add foreign key (cargo_id) references public.cargos(id);
alter table public.salarios add foreign key (created_by) references public.usuarios(id);
alter table public.folhas_pagamento add foreign key (created_by) references public.usuarios(id);
alter table public.itens_folha_pagamento add foreign key (folha_pagamento_id) references public.folhas_pagamento(id) on delete cascade;
alter table public.itens_folha_pagamento add foreign key (usuario_id) references public.usuarios(id);
alter table public.itens_folha_pagamento add foreign key (salario_id) references public.salarios(id);
alter table public.itens_folha_pagamento add foreign key (lancamento_financeiro_id) references public.lancamentos_financeiros(id);
alter table public.transacoes_bancarias_importadas add foreign key (conta_bancaria_id) references public.contas_bancarias(id);
alter table public.transacoes_bancarias_importadas add foreign key (created_by) references public.usuarios(id);
alter table public.conciliacoes_bancarias add foreign key (transacao_importada_id) references public.transacoes_bancarias_importadas(id) on delete cascade;
alter table public.conciliacoes_bancarias add foreign key (lancamento_financeiro_id) references public.lancamentos_financeiros(id) on delete set null;
alter table public.conciliacoes_bancarias add foreign key (conciliado_por) references public.usuarios(id);
alter table public.orcamentos add foreign key (created_by) references public.usuarios(id);
alter table public.orcamento_itens add foreign key (orcamento_id) references public.orcamentos(id) on delete cascade;
alter table public.orcamento_itens add foreign key (conta_contabil_id) references public.plano_contas(id);
alter table public.orcamento_itens add foreign key (centro_custo_id) references public.centros_custo(id);
alter table public.pastas add foreign key (parent_id) references public.pastas(id) on delete cascade;
alter table public.pastas add foreign key (criado_por) references public.usuarios(id) on delete set null;
alter table public.documentos add foreign key (pasta_id) references public.pastas(id) on delete set null;
alter table public.documentos add foreign key (criado_por) references public.usuarios(id) on delete restrict;
alter table public.documentos add foreign key (editado_por) references public.usuarios(id) on delete set null;
alter table public.documentos_versoes add foreign key (documento_id) references public.documentos(id) on delete cascade;
alter table public.documentos_versoes add foreign key (criado_por) references public.usuarios(id) on delete set null;
alter table public.documentos_uploads add foreign key (documento_id) references public.documentos(id) on delete cascade;
alter table public.documentos_uploads add foreign key (criado_por) references public.usuarios(id) on delete set null;
alter table public.documentos_compartilhados add foreign key (documento_id) references public.documentos(id) on delete cascade;
alter table public.documentos_compartilhados add foreign key (usuario_id) references public.usuarios(id) on delete cascade;
alter table public.documentos_compartilhados add foreign key (compartilhado_por) references public.usuarios(id) on delete set null;
alter table public.templates add foreign key (criado_por) references public.usuarios(id) on delete set null;
alter table public.salas_chat add foreign key (documento_id) references public.documentos(id) on delete cascade;
alter table public.salas_chat add foreign key (criado_por) references public.usuarios(id) on delete restrict;
alter table public.salas_chat add foreign key (participante_id) references public.usuarios(id) on delete cascade;
alter table public.mensagens_chat add foreign key (sala_id) references public.salas_chat(id) on delete cascade;
alter table public.mensagens_chat add foreign key (usuario_id) references public.usuarios(id) on delete restrict;
alter table public.embeddings add foreign key (indexed_by) references public.usuarios(id) on delete set null;
alter table public.mcp_audit_log add foreign key (usuario_id) references public.usuarios(id);
alter table public.mcp_quotas add foreign key (usuario_id) references public.usuarios(id);
alter table public.contrato_partes add foreign key (contrato_id) references public.contratos(id) on delete cascade;
alter table public.contrato_status_historico add foreign key (contrato_id) references public.contratos(id) on delete cascade;
alter table public.contrato_status_historico add foreign key (changed_by) references public.usuarios(id) on delete set null;
alter table public.contrato_tags add foreign key (contrato_id) references public.contratos(id) on delete cascade;
alter table public.contrato_tags add foreign key (tag_id) references public.tags(id) on delete cascade;
alter table public.processo_tags add foreign key (processo_id) references public.acervo(id) on delete cascade;
alter table public.processo_tags add foreign key (tag_id) references public.tags(id) on delete cascade;
alter table public.pericias add foreign key (advogado_id) references public.advogados(id) on delete cascade;
alter table public.pericias add foreign key (processo_id) references public.acervo(id) on delete cascade;
alter table public.pericias add foreign key (orgao_julgador_id) references public.orgao_julgador(id) on delete set null;
alter table public.pericias add foreign key (especialidade_id) references public.especialidades_pericia(id) on delete set null;
alter table public.pericias add foreign key (perito_id) references public.terceiros(id) on delete set null;
alter table public.pericias add foreign key (responsavel_id) references public.usuarios(id) on delete set null;
alter table public.fornecedores add foreign key (endereco_id) references public.enderecos(id);
alter table public.fornecedores add foreign key (created_by) references public.usuarios(id) on delete set null;
alter table public.todo_items add foreign key (usuario_id) references public.usuarios(id) on delete cascade;
alter table public.todo_subtasks add foreign key (todo_id) references public.todo_items(id) on delete cascade;
alter table public.todo_comments add foreign key (todo_id) references public.todo_items(id) on delete cascade;
alter table public.todo_files add foreign key (todo_id) references public.todo_items(id) on delete cascade;
alter table public.todo_assignees add foreign key (todo_id) references public.todo_items(id) on delete cascade;
alter table public.todo_assignees add foreign key (usuario_id) references public.usuarios(id) on delete restrict;
alter table public.notificacoes add foreign key (usuario_id) references public.usuarios(id) on delete cascade;
