...
const options: Options = {
  definition: {
    ...
    info: {
      title: "Sinesys API",
      version: "1.0.0",
      description: "Documentação da API do Sinesys",
      contact: {
        name: "Sinesys",
    ...
    components: {
      securitySchemes: {
        ...
        serviceApiKey: {
          ...
          description:
            "API Key para autenticação de jobs do sistema. Usado por scripts automatizados e processos agendados.",
        },
      },
      schemas: {
        Error: {
        ...
        BaseCapturaTRTParams: {
          ...
          properties: {
            advogado_id: {
              type: "integer",
              description:
                "ID do advogado na tabela advogados. O backend buscará automaticamente a credencial correspondente para este advogado, TRT e grau.",
              example: 1,
            },
            trt_codigo: {
              type: "string",
              description:
                "Código do tribunal trabalhista (TRT1 a TRT24 ou TST)",
              enum: [
                "TRT1",
                "TRT2",
                "TRT3",
            ...
            grau: {
              ...
              description:
                "Grau do processo (primeiro_grau, segundo_grau ou tribunal_superior)",
        ...
        PendentesManifestacaoParams: {
          ...
          properties: {
            ...
            filtroPrazo: {
              ...
              description:
                "Filtro de prazo para processos pendentes. Padrão: sem_prazo",
              example: "sem_prazo",
            },
          },
        },
        AtribuirResponsavelRequest: {
          ...
          properties: {
            responsavelId: {
              ...
              nullable: true,
              description:
                "ID do usuário responsável. Use null para desatribuir responsável. Se omitido, mantém o responsável atual.",
              example: 15,
            },
          },
        },
        AtualizarTipoDescricaoRequest: {
          ...
          properties: {
            tipoExpedienteId: {
              ...
              nullable: true,
              description:
                "ID do tipo de expediente. Use null para remover tipo.",
              example: 1,
            },
            descricaoArquivos: {
              type: "string",
              ...
              example:
                "Documentos anexados: petição inicial, documentos pessoais",
            },
          },
        },
        ...
        Parcela: {
          ...
          properties: {
            ...
            status: {
              type: "string",
              enum: ["pendente", "recebida", "paga", "atrasado"],
            },
            formaPagamento: {
              type: "string",
              enum: [
        ...
        Documento: {
          ...
          properties: {
            ...
            conteudo: {
              type: "object",
              description: "Conteúdo JSON do Plate.js",
            },
            pasta_id: {
              type: "integer",
              nullable: true,
            ...
            editado_por: {
              type: "integer",
              nullable: true,
              description: "ID do último editor",
            },
        ...
        CriarDocumentoParams: {
          ...
          properties: {
            titulo: {
              type: "string",
              description: "Título do documento (1-500 chars)",
            },
            conteudo: {
              type: "object",
              description: "Conteúdo JSON do editor",
            },
            pasta_id: {
              type: "integer",
              nullable: true,
        ...
        CriarPastaParams: {
          ...
          properties: {
            nome: {
              type: "string",
              description: "Nome da pasta (1-200 chars)",
            },
            ...
            cor: {
              type: "string",
              nullable: true,
              description: "Formato hex (#RRGGBB)",
            },
        ...
        CriarTemplateParams: {
          ...
          properties: {
            titulo: {
              type: "string",
              description: "Título do template (1-200 chars)",
            },
            descricao: { type: "string", nullable: true },
            conteudo: {
              type: "object",
        ...
        DocumentoUpload: {
          ...
          properties: {
            ...
            tipo_media: {
              type: "string",
              enum: ["imagem", "video", "audio", "pdf", "outros"],
            },
            criado_por: { type: "integer" },
            created_at: { type: "string", format: "date-time" },
          },
        ...
        MetricasEscritorio: {
          ...
          properties: {
            ...
            processosAtivos: {
              type: "integer",
              description: "Processos com status ativo",
            },
            processosAtivosUnicos: {
              type: "integer",
              description: "Contagem por número de processo único",
            },
            totalAudiencias: {
              type: "integer",
              description: "Total de audiências",
            },
            audienciasMes: {
              type: "integer",
              description: "Audiências do mês atual",
            },
            totalExpedientes: {
              type: "integer",
            ...
            expedientesPendentes: {
              type: "integer",
              description: "Expedientes aguardando resolução",
            },
            expedientesVencidos: {
              type: "integer",
              description: "Expedientes com prazo vencido",
            },
            totalUsuarios: {
              type: "integer",
            ...
            taxaResolucao: {
              type: "integer",
              description: "Percentual de expedientes resolvidos no prazo",
            },
            comparativoMesAnterior: {
              ...
              properties: {
                processos: {
                  type: "integer",
                  description: "Variação percentual de processos",
                },
                audiencias: {
                  type: "integer",
                  description: "Variação percentual de audiências",
                },
                expedientes: {
                  type: "integer",
                  description: "Variação percentual de expedientes",
                },
              },
            },
            evolucaoMensal: {
        ...
        CargaUsuario: {
          ...
          properties: {
            ...
            processosAtivos: {
              type: "integer",
              description: "Processos atribuídos ao usuário",
            },
            expedientesPendentes: {
              type: "integer",
              description: "Expedientes pendentes do usuário",
            },
            audienciasProximas: {
              type: "integer",
              description: "Audiências nos próximos 7 dias",
            },
            cargaTotal: {
              type: "integer",
              description: "Score ponderado de carga de trabalho",
            },
          },
        },
        PerformanceAdvogado: {
          ...
          properties: {
            ...
            baixasSemana: {
              type: "integer",
              description: "Expedientes baixados na semana",
            },
            baixasMes: {
              type: "integer",
              description: "Expedientes baixados no mês",
            },
            taxaCumprimentoPrazo: {
              type: "integer",
              description: "Percentual de baixas dentro do prazo",
            },
            expedientesVencidos: {
              type: "integer",
              description: "Expedientes atualmente vencidos",
            },
          },
        },
        StatusCaptura: {
          ...
          properties: {
            ...
            status: {
              type: "string",
              enum: ["sucesso", "erro", "pendente", "executando"],
            },
